...
#import "PlaceGrannysController.h"

@interface PlaceGrannysController ()

@end

@implementation PlaceGrannysController
@synthesize map;
...
- (void)viewDidLoad
{
    ...
    // работаем с API
    self.apiString = [NSString stringWithFormat:@"%@/json/getstreet/site/grannys",domain_server_api];
