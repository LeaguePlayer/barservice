...
#import "VideoGrannysController.h"
...
@interface VideoGrannysController ()

@end

@implementation VideoGrannysController
...
- (void)viewDidLoad
{
    ...
    // работаем с API
    self.apiString = [NSString stringWithFormat:@"%@/json/getvideos/site/grannys",domain_server_api];
    [self startAPI];
...
-(void)buildContent
{
    ...
    backgroundPlace= [self makeMainBackgroundwithBorder:YES andHeightIs:[dataTable count]*heightCell+height_top_padding_table+bottomPadding andSwitchType:@"grannys"];
