...
#import "OrderIcemanViewController.h"

@interface OrderIcemanViewController ()

@end

@implementation OrderIcemanViewController
...
- (void)viewDidLoad
{
    ...
    self.type_order.text = @"Заявка IceMan";
    ...
    mansLabel.textColor = [UIColor whiteColor];
    ...
    UIView *backgroundPlace= [self makeMainBackgroundwithBorder:NO andHeightIs:content_height andSwitchType:@"iceman"];
    ...
    UIView *buttonReserve = [self makeReserveButtonByPositionAtY:backgroundPlace.frame.size.height-50 andAction:@"goToReserveWithSendData" withTitle:@"Заказать лёд"];
