...
#import "PlaceBarserviceController.h"

@interface PlaceBarserviceController ()

@end

@implementation PlaceBarserviceController
@synthesize map;
...
- (void)viewDidLoad
{
    ...
    // работаем с API
    self.apiString = [NSString stringWithFormat:@"%@/json/getstreet/site/barservice",domain_server_api];
